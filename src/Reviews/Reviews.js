                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
                        ...
                        <div>
                            <div className="border rounded-lg p-4">
                                ...
                                <Link to='/Reviews' className="block bg-white hover:bg-gray-100 active:bg-gray-200 focus-visible:ring ring-indigo-300 border text-gray-500 text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-4 md:px-8 py-2 md:py-3">Write a review</Link>
                            </div>
                        </div>
